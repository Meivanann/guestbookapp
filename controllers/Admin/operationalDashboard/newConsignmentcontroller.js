...
module.exports = {
    ...
    postNewConsignment: (req,res) => {
        ...
        connection.query("SELECT * FROM consignment where cn_no = ?;", req.body.cn_no, (err,rows) => {
            if(err){
                console.log(err);
            } else if (rows.length == 0 ){
                var tracking_data1 = {
                ...
                var consignment_data={
                    ...
                    "weight_min_rate":req.body.weight_min_rate,
                    "weight_size":req.body.weight_size,
                    "weight_rate":req.body.weight_rate,
                ...
                connection.query(query,consignment_data, function (error, results, fields) {
                    ...
                    res.json({
                        ...
                        var log_data = {
                            ...
                            "cn_no"   : req.body.cn_no,
                            "status": " has created new Consignment No. [" + req.body.cn_no + " ] and pushed to " + status
                        }
