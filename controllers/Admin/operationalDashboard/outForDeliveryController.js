...
totalnumber=totalnumberdata[0].totalcount
        ...
        if(search!=undefined && search!='')
        {
            query ="select o.*, c.quantity, c.expiry_date ,c.cn_datetime from out_for_delivery o, consignment c where o.status = 'In-progress' and o.cn_no = c.cn_no and  (c.cn_no like '%"+search+"%' or c.shipper_code like '%"+search+"%' or  c.receiver_name like '%"+search+"%' or  c.destination_code like '%"+search+"%' or  o.driver_name like '%"+search+"%' ) " + sortcondition + "";
        }
